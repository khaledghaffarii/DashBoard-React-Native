  ...
  render() {
    return (
      <SafeAreaView style={styles.overview}>
          {/* <Menu
            ref={this.setMenuRef}
            button={<Text onClick={this.showMenu}>Show menu</Text>}
          ></Menu>
          <MenuItem onClick={ ()=> this.hideMenu}>Menu item 1</MenuItem>
          <MenuItem onClick={ ()=> this.hideMenu}>Menu item 2</MenuItem>
          <MenuItem onClick={ ()=> this.hideMenu} disabled>
            Menu item 3
          </MenuItem>
          <MenuDivider />
          <MenuItem onClick={this.hideMenu}>Menu item 4</MenuItem> */}
